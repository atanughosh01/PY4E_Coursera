...
You can export your own tracks from iTunes and create a database, but for the database that you
turn in for this assignment, only use the Library.xml data that is provided.
...
file_name = input("\nEnter File Name : ")
if len(file_name) < 1:
    print("(Considering 'Library.xml' as the working file)")
